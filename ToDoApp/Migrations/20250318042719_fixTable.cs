    ...
    public partial class fixTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentExamAnswers", x => new { x.StudentExamId, x.ExamQuestionId });
                    table.ForeignKey(
                        name: "FK_StudentExamAnswers_ExamQuestions_ExamQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamQuestions_ExamId_QuestionBankId",
                table: "ExamQuestions",
                columns: new[] { "ExamId", "QuestionBankId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExamAnswers_ExamQuestionId",
